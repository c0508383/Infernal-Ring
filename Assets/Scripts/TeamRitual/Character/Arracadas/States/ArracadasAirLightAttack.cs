...
public class ArracadasAirLightAttack : CharacterState
{
    public ArracadasAirLightAttack(CharacterStateMachine currentContext, CharacterStateFactory CharacterStateFactory) : base(currentContext, CharacterStateFactory)
    {
