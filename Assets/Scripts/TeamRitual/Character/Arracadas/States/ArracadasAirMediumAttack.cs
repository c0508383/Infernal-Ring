...
public class ArracadasAirMediumAttack : CharacterState
{
    public ArracadasAirMediumAttack(CharacterStateMachine currentContext, CharacterStateFactory CharacterStateFactory) : base(currentContext, CharacterStateFactory)
    {
