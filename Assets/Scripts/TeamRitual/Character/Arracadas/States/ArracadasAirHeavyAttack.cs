...
public class ArracadasAirHeavyAttack : CharacterState
{
    public ArracadasAirHeavyAttack(CharacterStateMachine currentContext, CharacterStateFactory CharacterStateFactory) : base(currentContext, CharacterStateFactory)
    {
